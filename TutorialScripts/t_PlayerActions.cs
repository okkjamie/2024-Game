...
public class t_PlayerActions : MonoBehaviour
{
    [Header("Settings")]
    ...
    public void BedRaycast()
    {
        ...
        )
        {
            ...
            if (hit.collider.TryGetComponent<t_Bed>(out t_Bed bed))
            {
                // Bed sleep method
                bed.Sleep();
            }
    ...
    public void ComputerRaycast()
    {
        ...
        )
        {
            ...
            if (hit.collider.TryGetComponent<t_Computer>(out t_Computer computer))
            {
